...
void main() {
  group('GalleryScreen Pull-to-Refresh', () {
    ...
    testWidgets('RefreshIndicator has onRefresh callback', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: GalleryScreen(
            imageListProvider: _FakeImageListProvider(),
    ...
    testWidgets('RefreshIndicator has displacement configured', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: GalleryScreen(
            imageListProvider: _FakeImageListProvider(),
      ...
      final refreshIndicator = tester.widget<RefreshIndicator>(find.byType(RefreshIndicator));
      expect(refreshIndicator.displacement, isNotNull);
    });
  });
}